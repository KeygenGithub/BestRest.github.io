...
/***/ "./src/js/modules/country_select.js":
/*!******************************************!*\
  !*** ./src/js/modules/country_select.js ***!
  \******************************************/
...
/* harmony export */ });
/* harmony import */ var country_codes_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! country-codes-list */ "./node_modules/country-codes-list/index.js");
/* harmony import */ var country_codes_list__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(country_codes_list__WEBPACK_IMPORTED_MODULE_0__);
...
var select = function select(selector) {
  var myCountryCodesObject = country_codes_list__WEBPACK_IMPORTED_MODULE_0___default().customList('countryCode', '+{countryCallingCode}');
  var btn = $(selector);
  var phone = document.getElementById("phone");
  var selected = false;
  btn.on("click", function (e) {
    var wrap = $(e.target);
    var parent = wrap.closest(".input");
    var placeholder = parent.find(".input__placeholder");
    var list = parent.find(".select__list");
  ...
  $(".select__list span").on("click", function (e) {
    var option = $(e.target);
    var selectedCountryCode = option.attr("data-value");
    ...
    var countryCodeNumber = myCountryCodesObject[selectedCountryCode].replaceAll("9", "\\9\\");
    inputmask__WEBPACK_IMPORTED_MODULE_1___default()({
      "mask": countryCodeNumber + "99999999999999",
      "placeholder": "",
...
/* harmony import */ var _country_select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./country_select */ "./src/js/modules/country_select.js");


$(function () {
  new _validator__WEBPACK_IMPORTED_MODULE_0__["default"]("#form").init();
  (0,_country_select__WEBPACK_IMPORTED_MODULE_1__["default"])(".js-select");
  $(".input__field").on("input", function (e) {
    var input = $(e.target);
    var placeholder = input.closest(".input").find(".input__placeholder");
  ...
  _createClass(Validator, [{
    ...
    value: function init() {
      ...
      this.form.on("submit", function (e) {
        ...
        _this.validationRequire();

        _this.validationPassword();

        _this.validationEmail();

        _this.validationCheckbox();

        if (!_this.errors.hasClass("visible")) {
          //submit form
          alert("Form sent successfully!");
        } else {
          setTimeout(function () {
            _this.errors.removeClass("visible");

            _this.checkboxError.removeClass("error");
          }, 4000);
        }
      });
    }
    ...
    key: "validationName",
    value: function validationName() {
      $(".validation-name").each(function (index, elem) {
        var input = $(elem);
        var error = input.closest(".input").find(".input__error");
    ...
    value: function validationRequire() {
      ...
      ;
      $(".validation-require").each(function (index, elem) {
        var input = $(elem);
        var error = input.closest(".input").find(".input__error");
    ...
    key: "validationPassword",
    value: function validationPassword() {
      var passwordVal = this.password.val();
      var passwordConfirmVal = this.passwordConfirm.val();
      var passwordError = $(".password-error");
      var passwordConfirmError = $(".passwordconfirm-error");
    ...
    key: "validationCheckbox",
    value: function validationCheckbox() {
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_init_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/init-form */ "./src/js/modules/init-form.js");
...
$(function () {
  var parallaxScenes = document.querySelectorAll(".parallax-scene");
  parallaxScenes.forEach(function (scene) {
