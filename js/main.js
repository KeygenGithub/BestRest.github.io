...
var registration = function registration(formData, url) {
...
var login = function login(formData, url, name, lname) {
  axios__WEBPACK_IMPORTED_MODULE_0___default()({
    method: "post",
    url: url,
    data: formData
...
var tasks = function tasks(formData, url, token, username) {
  axios__WEBPACK_IMPORTED_MODULE_0___default()({
    method: "get",
    url: url,
    data: formData,
...
/* harmony export */ });
/* harmony import */ var _post__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./post */ "./src/js/modules/post.js");
  ...
  _createClass(Validator, [{
    ...
    value: function init() {
      ...
      this.form.on("submit", function (e) {
        ...
        if (!_this.errors.hasClass("visible") && !_this.checkboxError.hasClass("error")) {
          (0,_post__WEBPACK_IMPORTED_MODULE_0__.registration)(_this.createFormData(), "https://api.topmediagroups.com/api/v1/users");
        } else {
          setTimeout(function () {
